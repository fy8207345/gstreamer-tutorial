...
static gboolean handle_message(GstBus *bus, GstMessage *msg, CustomData01 *data);
static gboolean handle_keyboard(GIOChannel *source, GIOCondition cond, CustomData01 *data);
...
static void analyze_streams(CustomData01 *data){
    gint i;
    GstTagList *tags;
    gchar *str;
    guint rate;
