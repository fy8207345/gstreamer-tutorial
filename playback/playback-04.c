...
static void cb_message(GstBus *bus, GstMessage *msg, CustomData04 *data) {
...
static gboolean refresh_ui(CustomData04 *data){
    GstQuery *query;
    gboolean result;
