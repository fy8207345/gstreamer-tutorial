...
static gboolean handle_message (GstBus *bus, GstMessage *msg, CustomData02 *data);
static gboolean handle_keyboard (GIOChannel *source, GIOCondition cond, CustomData02 *data);
...
static void analyze_streams (CustomData02 *data) {
    gint i;
    GstTagList *tags;
    gchar *str;
    guint rate;
